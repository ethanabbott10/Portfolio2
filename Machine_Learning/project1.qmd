...
eligible = pd.read_parquet("https://github.com/ethanabbott10/Sports_Data/blob/main/data/eligible.parquet")
ineligible = pd.read_parquet("https://github.com/ethanabbott10/Sports_Data/blob/main/data/ineligible.parquet")
