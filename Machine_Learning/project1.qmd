...
# Load cleaned data
eligible = from_parquet("https://github.com/ethanabbott10/Sports_Data/blob/main/data/eligible.parquet")
ineligible = from_parquet("https://github.com/ethanabbott10/Sports_Data/blob/main/data/ineligible.parquet")
