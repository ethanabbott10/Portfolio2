...
# Load cleaned data
eligible = pandas.from_parquet("https://github.com/ethanabbott10/Sports_Data/blob/main/data/eligible.parquet")
ineligible = pandas.from_parquet("https://github.com/ethanabbott10/Sports_Data/blob/main/data/ineligible.parquet")
