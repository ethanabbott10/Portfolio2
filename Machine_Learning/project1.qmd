...
# Load cleaned data
eligible = read_parquet("https://github.com/ethanabbott10/Sports_Data/blob/main/data/eligible.parquet")
ineligible = read_parquet("https://github.com/ethanabbott10/Sports_Data/blob/main/data/ineligible.parquet")
