...
eligible.to_parquet("ethanabbott10/Sports_Data/data/eligible.parquet")
ineligible.to_parquet("ethanabbott10/Sports_Data/data/ineligible.parquet")
```
